...
myQCLdata[CORE=="CORE_03", NO:=NA]
myQCLdata[CORE=="CORE_03", N2O:=NA]
myQCLdata[CORE=="CORE_03", CO2:=NA]
myQCLdata[CORE=="CORE_03", CH4:=NA]
myQCLdata[CORE=="CORE_03", NH3:=NA]
myQCLdata[CORE=="CORE_03", H2O:=NA]

myQCLdata <- myQCLdata[newColumn %in% c("Fendt", "New.Graswang"), ]
myQCLdata[newColumn == "New.Graswang", newColumn:= "Graswang"]
